...
function App() {
  ...
  const [speed, setSpeed] = React.useState(0.008);
  ...
  return (
    <div style={{ width: '100vw', height: '100vh', position: 'relative' }}>
      ...
      <div style={{
        ...
        display: 'flex', gap: 20, flexWrap: 'wrap', justifyContent: 'center', zIndex: 10
      }}>
        <div>
          <label>🎨 رنگ: </label>
      ...
      {showHelp && (
        <div style={{
          ...
          boxShadow: '0 10px 30px rgba(0,0,0,0.5)', color: 'white', textAlign: 'center', zIndex: 20
        }}>
